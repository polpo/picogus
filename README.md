...
ISA card emulation on the Raspberry Pi Pico's RP2040 microcontroller, and Raspberry Pi 3, 4, and CM4. Initially focusing on Gravis Ultrasound (GUS) sound card emulation.
